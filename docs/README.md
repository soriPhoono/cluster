...
| [metallb.md](metallb.md) | Removed | Replaced by Cilium LB IPAM + BGP; page kept as a pointer |
...
| [cilium.md](cilium.md) | Phase 1 deployed | CNI installed; eBGP rollout documented for phase 2 |
